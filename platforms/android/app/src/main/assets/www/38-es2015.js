...
/* harmony import */ var _index_824b185a_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./index-824b185a.js */ "./node_modules/@ionic/core/dist/esm/index-824b185a.js");
...
const Menu = class {
    constructor(hostRef) {
        ...
        this.ionWillOpen = Object(_core_c02a05e9_js__WEBPACK_IMPORTED_MODULE_0__["c"])(this, "ionWillOpen", 7);
        this.ionWillClose = Object(_core_c02a05e9_js__WEBPACK_IMPORTED_MODULE_0__["c"])(this, "ionWillClose", 7);
        this.ionDidOpen = Object(_core_c02a05e9_js__WEBPACK_IMPORTED_MODULE_0__["c"])(this, "ionDidOpen", 7);
        this.ionDidClose = Object(_core_c02a05e9_js__WEBPACK_IMPORTED_MODULE_0__["c"])(this, "ionDidClose", 7);
        this.ionMenuChange = Object(_core_c02a05e9_js__WEBPACK_IMPORTED_MODULE_0__["c"])(this, "ionMenuChange", 7);
    }
    ...
    async connectedCallback() {
        if (this.type === undefined) {
            this.type = _config_503c2549_js__WEBPACK_IMPORTED_MODULE_1__["b"].get('menuType', this.mode === 'ios' ? 'reveal' : 'overlay');
        }
        const el = this.el;
        ...
        _index_824b185a_js__WEBPACK_IMPORTED_MODULE_4__["m"]._register(this);
    ...
    disconnectedCallback() {
        ...
        _index_824b185a_js__WEBPACK_IMPORTED_MODULE_4__["m"]._unregister(this);
        if (this.animation) {
    ...
    setOpen(shouldOpen, animated = true) {
        return _index_824b185a_js__WEBPACK_IMPORTED_MODULE_4__["m"]._setOpen(this, shouldOpen, animated);
    }
    ...
    async loadAnimation() {
        ...
        this.animation = await _index_824b185a_js__WEBPACK_IMPORTED_MODULE_4__["m"]._createAnimation(this.type, this);
        if (!_config_503c2549_js__WEBPACK_IMPORTED_MODULE_1__["b"].getBoolean('animated', true)) {
    ...
    canStart(detail) {
        ...
        else if (_index_824b185a_js__WEBPACK_IMPORTED_MODULE_4__["m"]._getOpenSync()) {
            return false;
        }
    ...
    updateState() {
        ...
        if (!this.disabled) {
            _index_824b185a_js__WEBPACK_IMPORTED_MODULE_4__["m"]._setActiveMenu(this);
        }
    ...
    render() {
        ...
        return (Object(_core_c02a05e9_js__WEBPACK_IMPORTED_MODULE_0__["h"])(_core_c02a05e9_js__WEBPACK_IMPORTED_MODULE_0__["H"], { role: "navigation", class: {
                [mode]: true,
                [`menu-type-${type}`]: true,
            ...
            } }, Object(_core_c02a05e9_js__WEBPACK_IMPORTED_MODULE_0__["h"])("div", { class: "menu-inner", ref: el => this.menuInnerEl = el }, Object(_core_c02a05e9_js__WEBPACK_IMPORTED_MODULE_0__["h"])("slot", null)), Object(_core_c02a05e9_js__WEBPACK_IMPORTED_MODULE_0__["h"])("ion-backdrop", { ref: el => this.backdropEl = el, class: "menu-backdrop", tappable: false, stopPropagation: false })));
    }
...
const updateVisibility = async (menu) => {
    const menuEl = await _index_824b185a_js__WEBPACK_IMPORTED_MODULE_4__["m"].get(menu);
...
const MenuButton = class {
    constructor(hostRef) {
        ...
        this.type = 'button';
        this.onClick = async () => {
            return _index_824b185a_js__WEBPACK_IMPORTED_MODULE_4__["m"].toggle(this.menu);
        };
    }
    componentDidLoad() {
    ...
    render() {
        ...
        const menuIcon = _config_503c2549_js__WEBPACK_IMPORTED_MODULE_1__["b"].get('menuIcon', 'menu');
        const hidden = this.autoHide && !this.visible;
        const attrs = {
            type: this.type
        };
        return (Object(_core_c02a05e9_js__WEBPACK_IMPORTED_MODULE_0__["h"])(_core_c02a05e9_js__WEBPACK_IMPORTED_MODULE_0__["H"], { onClick: this.onClick, "aria-disabled": disabled ? 'true' : null, "aria-hidden": hidden ? 'true' : null, class: Object.assign({ [mode]: true }, Object(_theme_353a032e_js__WEBPACK_IMPORTED_MODULE_5__["c"])(color), { 'button': true, 'menu-button-hidden': hidden, 'menu-button-disabled': disabled, 'ion-activatable': true, 'ion-focusable': true }) }, Object(_core_c02a05e9_js__WEBPACK_IMPORTED_MODULE_0__["h"])("button", Object.assign({}, attrs, { disabled: disabled, class: "button-native" }), Object(_core_c02a05e9_js__WEBPACK_IMPORTED_MODULE_0__["h"])("slot", null, Object(_core_c02a05e9_js__WEBPACK_IMPORTED_MODULE_0__["h"])("ion-icon", { icon: menuIcon, mode: mode, lazy: false })), mode === 'md' && Object(_core_c02a05e9_js__WEBPACK_IMPORTED_MODULE_0__["h"])("ion-ripple-effect", { type: "unbounded" }))));
    }
...
const MenuController = class {
     ...
     */
    open(menu) {
        return _index_824b185a_js__WEBPACK_IMPORTED_MODULE_4__["m"].open(menu);
    }
    /**
     ...
     */
    close(menu) {
        return _index_824b185a_js__WEBPACK_IMPORTED_MODULE_4__["m"].close(menu);
    }
    /**
     ...
     */
    toggle(menu) {
        return _index_824b185a_js__WEBPACK_IMPORTED_MODULE_4__["m"].toggle(menu);
    }
    /**
     ...
     */
    enable(enable, menu) {
        return _index_824b185a_js__WEBPACK_IMPORTED_MODULE_4__["m"].enable(enable, menu);
    }
    /**
    ...
    swipeGesture(enable, menu) {
        return _index_824b185a_js__WEBPACK_IMPORTED_MODULE_4__["m"].swipeGesture(enable, menu);
    }
    /**
     ...
     */
    isOpen(menu) {
        return _index_824b185a_js__WEBPACK_IMPORTED_MODULE_4__["m"].isOpen(menu);
    }
    /**
     ...
     */
    isEnabled(menu) {
        return _index_824b185a_js__WEBPACK_IMPORTED_MODULE_4__["m"].isEnabled(menu);
    }
    /**
     ...
     */
    get(menu) {
        return _index_824b185a_js__WEBPACK_IMPORTED_MODULE_4__["m"].get(menu);
    }
    /**
     * Get the instance of the opened menu. Returns `null` if a menu is not found.
     */
    getOpen() {
        return _index_824b185a_js__WEBPACK_IMPORTED_MODULE_4__["m"].getOpen();
    }
    /**
     * Get all menu instances.
     */
    getMenus() {
        return _index_824b185a_js__WEBPACK_IMPORTED_MODULE_4__["m"].getMenus();
    }
    /**
     ...
     */
    isAnimating() {
        return _index_824b185a_js__WEBPACK_IMPORTED_MODULE_4__["m"].isAnimating();
    }
    /**
    ...
    async registerAnimation(name, animation) {
        return _index_824b185a_js__WEBPACK_IMPORTED_MODULE_4__["m"].registerAnimation(name, animation);
    }
...
const MenuToggle = class {
    ...
    render() {
        const mode = Object(_core_c02a05e9_js__WEBPACK_IMPORTED_MODULE_0__["d"])(this);
        const hidden = this.autoHide && !this.visible;
        return (Object(_core_c02a05e9_js__WEBPACK_IMPORTED_MODULE_0__["h"])(_core_c02a05e9_js__WEBPACK_IMPORTED_MODULE_0__["H"], { onClick: this.onClick, "aria-hidden": hidden ? 'true' : null, class: {
                [mode]: true,
