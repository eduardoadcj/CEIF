...
/* harmony import */ var ionic_selectable__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ionic-selectable */ "./node_modules/ionic-selectable/esm2015/ionic-selectable.min.js");
...
let AuthService = class AuthService {
    constructor(afAuth, router, alertController) {
        this.afAuth = afAuth;
        this.router = router;
...
let LoginComponent = class LoginComponent {
    constructor(fb, router, auth, recuperar) {
        this.fb = fb;
        this.router = router;
        this.auth = auth;
...
let RecuperarSenhaComponent = class RecuperarSenhaComponent {
    constructor(fb, auth) {
        this.fb = fb;
        this.auth = auth;
...
RecuperarSenhaComponent.ctorParameters = () => [
    { type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"] },
...
let EmprestimoComponent = class EmprestimoComponent {
    constructor(materiaisService, locacaoService, fb, categoriasService, auth, router, alertController) {
...
EmprestimoComponent.ctorParameters = () => [
...
let AddcategoriaComponent = class AddcategoriaComponent {
    constructor(fb, categoriaService, alertController, router) {
        this.fb = fb;
    ...
    presentErroCategoriaCadastrado() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            const alert = yield this.alertController.create({
                header: 'Sucesso',
...
AddcategoriaComponent.ctorParameters = () => [
    { type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"] },
...
let AddequipamentoComponent = class AddequipamentoComponent {
    constructor(fb, categoriaService, materiaisService, alertController, router) {
        this.fb = fb;
        this.categoriaService = categoriaService;
        this.materiaisService = materiaisService;
        this.alertController = alertController;
    ...
    addMaterial() {
        if (this.equipamentoForm.value.idCategoria == null || this.equipamentoForm.value.idCategoria == '') {
            ...
            this.categoriaService.buscarPorId(this.equipamentoForm.value.idCategoria, (nome) => {
                let categoria = {
...
AddequipamentoComponent.ctorParameters = () => [
    { type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"] },
    { type: src_app_service_categorias_service__WEBPACK_IMPORTED_MODULE_3__["CategoriasService"] },
...
let ListCategoriaPage = class ListCategoriaPage {
...
ListCategoriaPage.ctorParameters = () => [
...
let ListEquipamentoComponent = class ListEquipamentoComponent {
...
ListEquipamentoComponent.ctorParameters = () => [
...
let CategoriasService = class CategoriasService {
    ...
    buscarPorId(key, onComplete) {
        let categoriaDoc = this.afs.doc('categoria/' + key + '');
...
let LocacaoService = class LocacaoService {
    ...
    buscarLocacao(onComplete) {
        this.getUserUid((userUid) => {
            onComplete(this.afs.collection('locacao', ref => ref.where('uid', '==', userUid)).valueChanges());
            console.log(userUid);
        });
    }
...
let MateriaisService = class MateriaisService {
    ...
    buscarLista() {
        let materialDoc = this.afs.doc('material');
        return materialDoc.valueChanges();
    }
    buscarMateriaCategoria(key) {
        return this.afs.collection('material', ref => ref.where('categoria.id', '==', key)).valueChanges();
    }
};
MateriaisService.ctorParameters = () => [
    { type: _angular_fire_firestore__WEBPACK_IMPORTED_MODULE_2__["AngularFirestore"] }
];
